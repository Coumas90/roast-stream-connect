-- =============================================================================
-- SECURITY FIX PART 2: Convert remaining SECURITY DEFINER view-like functions
-- =============================================================================

-- Fix the remaining view-like functions to use SECURITY INVOKER
...
-- 6. Fix get_recent_alert_incidents function (view-like)
...
VALUES (
  'info',
  'security_fix',
  'Converted additional SECURITY DEFINER view-like functions to SECURITY INVOKER',
  jsonb_build_object(
    ...
    'timestamp', now(),
    'security_issue', 'security_definer_view_part2'
  )
);