-- Apply the 3 critical adjustments for production-ready atomic leasing (Part 1)
...
-- 3. Add UNIQUE constraint on heartbeats using regular index (since CONCURRENTLY doesn't work in migrations)
CREATE UNIQUE INDEX IF NOT EXISTS job_heartbeats_job_name_uidx
