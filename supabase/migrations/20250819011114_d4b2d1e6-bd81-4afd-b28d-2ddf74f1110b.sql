...
CREATE POLICY "pos_rotation_metrics_insert_admin" ON public.pos_rotation_metrics
FOR INSERT WITH CHECK (is_tupa_admin());

CREATE POLICY "pos_rotation_metrics_update_admin" ON public.pos_rotation_metrics
FOR UPDATE USING (is_tupa_admin()) WITH CHECK (is_tupa_admin());

CREATE POLICY "pos_rotation_metrics_delete_admin" ON public.pos_rotation_metrics
FOR DELETE USING (is_tupa_admin());
