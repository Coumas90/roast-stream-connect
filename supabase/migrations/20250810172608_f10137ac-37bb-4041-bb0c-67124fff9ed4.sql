...
-- Unificar eventos de auditoría a los valores permitidos por el constraint:
-- 'sent' | 'accepted' | 'revoked'

-- create_location_invitation: registrar 'sent' (en lugar de 'created')
...
-- rotate_invitation_token: registrar 'sent' (en lugar de 'resent')
